...
<div class='parallax-container valign-wrapper'>
    ...
    <div class='parallax'><img src='img/recipe/<?php echo $recipe->image; ?>' alt='Unsplashed background img 2'></div>
</div>
...
<div class='container'>
    <div class='row'>
        ...
        <div class='col s12 m8'>
            <h5>Title: <?php echo $recipe->title; ?></h5>
            <p>
                Cooking time: <?php echo $recipe->cooktime; ?><br>
                Price: <?php echo $recipe->price; ?><br>
                Origin:<?php
